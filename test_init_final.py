...
def init():
	...
	if int(basicSetting[13]) == 0 :
		endTime = tmp_now.replace(hour=int(basicSetting[0]), minute=int(basicSetting[0]), second = int(0))
		endTime = endTime + datetime.timedelta(days=int(1000))
	else :
		endTime = tmp_now.replace(hour=int(basicSetting[0]), minute=int(basicSetting[0]), second = int(0)0
		if endTime < tmp_now :			
